...
Route::get('/', function () {
    ...
    return view('portal_it.layouts.index', compact('gerencias','puestos'));})->name('indexportal');
...
Route::middleware('auth')->group(function () {
        ...
        Route::get('/parametros', function() { 
            ...
            //Route::get('/asignar-rol', [RoleController::class,'assignRole'])->name('asignar-rol.submit');
