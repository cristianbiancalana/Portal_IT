    ...
    <div class="row">
        ...
        <div class="col-6 mt-4">
                <h3 class="text-white">Crear Gerencia</h3>
                    <form action="{{route('gerencias.update',$gerencia)}}" method="post">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <strong>Nombre de la Gerencia</strong>
                            <input type="text" name="nombre_gerencia" id="nombre_gerencia"  class="form-control" style="height:25px;" value="{{$gerencia->nombre_gerencia}}">
                        </div>
                        <div class="form-group">
                            <strong>Nombre del Gerente</strong>
                            <input type="text" name="gerente_acargo" id="gerente_acargo"  class="form-control" style="height:25px;" value="{{$gerencia->gerente_acargo}}">
                        </div>
                        <div class="row justify-content-center">
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4 text-center mt-2">
                                <a href="{{route('vistagerencias')}}" class="btn btn-primary" style="width:100px;">Volver</a>
                            </div>
                        </div>
                    </form>
        </div>
