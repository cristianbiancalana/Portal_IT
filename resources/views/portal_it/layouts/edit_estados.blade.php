...
<div class="container">
    <div class="row">
        ...
        <div class="alert alert-danger">
                ...
                </strong>Error al editar el estado, verificar: <br><br>
                <ul>
        ...
        <div class="col-6 mt-4">
                <h3 class="text-white">Actualizar Estado</h3>
                    <form action="{{route('estados.update',$estado)}}" method="post">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <strong>Nombre del Estado</strong>
                            <input type="text" name="name_estados" id="name_estados"  class="form-control" style="height:25px;" value="{{$estado->name_estados}}">
                        </div>
                        <div class="row justify-content-center">
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4 text-center mt-2">
                                <a href="{{route('vistaestados')}}" class="btn btn-primary" style="width:100px;">Volver</a>
                            </div>
                        </div>
                    </form>
        </div>
