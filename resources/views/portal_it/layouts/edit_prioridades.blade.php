...
<div class="container">
    <div class="row">
        <div class="col-12">
            <div>
                <h2 class="text-white">Prioridad</h2>
            </div>
        </div>
        @if ($errors->any())
        <div class="alert alert-danger">
                ...
                </strong>Error al editar el prioridad, verificar: <br><br>
                <ul>
        ...
        <div class="col-6 mt-4">
                <h3 class="text-white">Actualizar Prioridad</h3>
                    <form action="{{route('prioridades.update',$prioridad)}}" method="post">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <strong>Nombre de la Prioridad</strong>
                            <input type="text" name="name_prioridades" id="name_prioridades"  class="form-control" style="height:25px;" value="{{$prioridad->name_prioridades}}">
                        </div>
                        <div class="row justify-content-center">
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4 text-center mt-2">
                                <a href="{{route('vistaprioridades')}}" class="btn btn-primary" style="width:100px;">Volver</a>
                            </div>
                        </div>
                    </form>
        </div>
