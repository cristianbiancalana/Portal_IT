...
<div class="container">
    <div class="row">
        <div class="col-12">
            <div>
                <h2 class="text-white">Sistemas</h2>
            </div>
        </div>
        @if ($errors->any())
        <div class="alert alert-danger">
                ...
                </strong>Error al editar el sistema<br><br>
                <ul>
        ...
        <div class="alert alert-warning">
                ...
                </strong>Sistema Eliminado<br><br>
                <ul>
                    @foreach ($errors->all() as $error)
                        <li>{{ $error }}</li>
                    @endforeach
        ...
        <div class="col-6 mt-4">
            <h3 class="text-white">Listado de Sistemas</h3>
            <div style="max-width: 1500px; margin: 0 auto; text-align:center;">
                <table class="table table-sm table-dark table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                        <th scope="row">{{$sistema->id}}</th>
                        <td>{{$sistema->name_sistema}}</td>
                        <td style="width:150px; height: 20px; ">
                            <a href="{{route('sistemas.edit',$sistema)}}" style="color:azure;">
                                <svg style="width: 22px; height: 20px;" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <div class="col-6 mt-4">
        <h3 class="text-white">Crear Sistema</h3>
            <form action="{{route('store.sistemas')}}" method="post">
                @csrf
                <div class="form-group">
                    <strong>Nombre del Sistema</strong>
                    <input type="text" name="name_sistema" id="name_sistema"  class="form-control" style="height:25px;">
                </div>
