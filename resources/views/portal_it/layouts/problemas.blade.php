...
<div class="container">
    <div class="row">
        <div class="col-12">
            <div>
                <h2 class="text-white">Problemas</h2>
            </div>
        </div>
        @if ($errors->any())
        <div class="alert alert-danger">
                ...
                </strong>Error al editar el problema<br><br>
                <ul>
        ...
        <div class="alert alert-warning">
                ...
                </strong>Problema Eliminado<br><br>
                <ul>
                    @foreach ($errors->all() as $error)
                        <li>{{ $error }}</li>
                    @endforeach
        ...
        <div class="col-6 mt-4">
            <h3 class="text-white">Listado de Problemas</h3>
            <div style="max-width: 1500px; margin: 0 auto; text-align:center;">
                <table class="table table-sm table-dark table-hover">
                    ...
                    <tbody>
                        ...
                        <td>{{$problema->name_problema}}</td>
                        <td style="width:150px; height: 20px; ">
                            <a href="{{route('problemas.edit',$problema)}}" style="color:azure;">
                                <svg style="width: 22px; height: 20px;" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <div class="col-6 mt-4">
        <h3 class="text-white">Crear Problema</h3>
            <form action="{{route('store.problemas')}}" method="post">
                @csrf
                <div class="form-group">
                    <strong>Nombre del Problema</strong>
                    <input type="text" name="name_problema" id="name_problema"  class="form-control" style="height:25px;">
                </div>
