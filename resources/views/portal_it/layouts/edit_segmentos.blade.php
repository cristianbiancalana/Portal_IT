...
<div class="container">
    <div class="row">
        <div class="col-12">
            <div>
                <h2 class="text-white">Segmento</h2>
            </div>
        </div>
        @if ($errors->any())
        <div class="alert alert-danger">
                ...
                </strong>Error al editar el segmento, verificar: <br><br>
                <ul>
        ...
        <div class="col-6 mt-4">
                <h3 class="text-white">Actualizar Segmento</h3>
                    <form action="{{route('segmentos.update',$segmento)}}" method="post">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <strong>Nombre del Segmento</strong>
                            <input type="text" name="name_segmento" id="name_segmento"  class="form-control" style="height:25px;" value="{{$segmento->name_segmento}}">
                        </div>
                        <div class="row justify-content-center">
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4 text-center mt-2">
                                <a href="{{route('vistasegmentos')}}" class="btn btn-primary" style="width:100px;">Volver</a>
                            </div>
                        </div>
                    </form>
        </div>
