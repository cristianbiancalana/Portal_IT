...
<div class="container">
    <div class="row">
        <div class="col-12">
            <div>
                <h2 class="text-white">Tipo de Recurso</h2>
            </div>
        </div>
        @if ($errors->any())
        <div class="alert alert-danger">
                ...
                </strong>Error al editar el recurso, verificar: <br><br>
                <ul>
        ...
        <div class="col-6 mt-4">
                <h3 class="text-white">Actualizar Recurso</h3>
                    <form action="{{route('typeresource.update',$tiposderecurso)}}" method="post">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <strong>Nombre del Recurso</strong>
                            <input type="text" name="name_tiposderecursos" id="name_tiposderecursos"  class="form-control" style="height:25px;" value="{{$tiposderecurso->name_tiposderecursos}}">
                        </div>
                        <div class="row justify-content-center">
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4 text-center mt-2">
                                <a href="{{route('vistatyperesource')}}" class="btn btn-primary" style="width:100px;">Volver</a>
                            </div>
                        </div>
                    </form>
        </div>
