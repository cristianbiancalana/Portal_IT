...
<div class="container">
    <div class="row">
        <div class="col-12">
            <div>
                <h2 class="text-white">Técnicos</h2>
            </div>
        </div>
        @if ($errors->any())
        <div class="alert alert-danger">
                ...
                </strong>Error al editar el técnico<br><br>
                <ul>
        ...
        <div class="alert alert-warning">
                ...
                </strong>Técnico Eliminado<br><br>
                <ul>
                    @foreach ($errors->all() as $error)
                        <li>{{ $error }}</li>
                    @endforeach
        ...
        <div class="col-8 mt-4">
            <h3 class="text-white">Listado de Técnicos</h3>
            <div style="max-width: 1500px; margin: 0 auto; text-align:center;">
                <table class="table table-sm table-dark table-hover">
                    ...
                    <tbody>
                        ...
                        <td>{{$tecnico->name_tecnicos}}</td>
                        <td>{{$tecnico->tel_tecnicos}}</td>
                        <td>{{$tecnico->email_tecnicos}}</td>
                        <td style="width:150px; height: 20px;">
                            <a href="{{route('tecnicos.edit',$tecnico)}}" style="color:azure;">
                                <svg style="width: 22px; height: 20px;" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <h3 class="text-white">Crear Técnico</h3>
            <form action="{{route('store.tecnicos')}}" method="post">
                @csrf
                <div class="form-group">
                    <strong>Nombre del Técnicos</strong>
                    <input type="text" name="name_tecnicos" id="name_tecnicos"  class="form-control" style="height:25px;">
                </div>
                <div class="form-group">
                    <strong>Teléfono del Técnico</strong>
                    <input type="text" name="tel_tecnicos" id="tel_tecnicos"  class="form-control" style="height:25px;">
                </div>
                <div class="form-group">
                    <strong>Email del Técnico</strong>
                    <input type="text" name="email_tecnicos" id="email_tecnicos"  class="form-control" style="height:25px;">
                </div>
