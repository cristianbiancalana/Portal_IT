...
<div class="container">
    <div class="row">
        <div class="col-12">
            <div>
                <h2 class="text-white">Proveedores</h2>
            </div>
        </div>
        @if ($errors->any())
        <div class="alert alert-danger">
                ...
                </strong>Error al editar el proveedor<br><br>
                <ul>
        ...
        <div class="alert alert-warning">
                ...
                </strong>Proveedor Eliminado<br><br>
                <ul>
                    @foreach ($errors->all() as $error)
                        <li>{{ $error }}</li>
                    @endforeach
            ...
            <div style="max-width: 1500px; margin: 0 auto; text-align:center;">
                <table class="table table-sm table-dark table-hover">
                    ...
                    <tbody>
                        ...
                        <td>{{$proveedor->contacto1_proveedor}}</td>
                        <td>{{$proveedor->tel1_proveedor}}</td>
                        <td style="width:150px; height: 20px;">
                            <a href="{{route('proveedores.view',$proveedor)}}" style="color:azure;">
                                <svg style="width: 22px; height: 20px;" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z"></path>
                                </svg>
                            </a>
                            <a href="{{route('proveedores.edit',$proveedor)}}" style="color:azure;">
                                <svg style="width: 22px; height: 20px;" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <h3 class="text-white">Crear Proveedor</h3>
            <form action="{{route('store.proveedores')}}" method="post">
                @csrf
                <div class="form-group">
                    <strong>Nombre del Proveedor</strong>
                    <input type="text" name="name_proveedor" id="name_proveedor"  class="form-control" style="height:25px;">
                </div>
                <div class="form-group">
                    <strong>Contacto del Proveedor</strong>
                    <input type="text" name="contacto1_proveedor" id="contacto1_proveedor"  class="form-control" style="height:25px;">
                </div>
                <div class="form-group">
                    <strong>Teléfono del Contacto</strong>
                    <input type="text" name="tel1_proveedor" id="tel1_proveedor"  class="form-control" style="height:25px;">
                </div>
                <div class="form-group">
                    <strong>Segundo Contacto</strong>
                    <input type="text" name="contacto2_proveedor" id="contacto2_proveedor"  class="form-control" style="height:25px;">
                </div>
                <div class="form-group">
                    <strong>Teléfono del Segundo Contacto</strong>
                    <input type="text" name="tel2_proveedor" id="tel2_proveedor"  class="form-control" style="height:25px;">
                </div>
                <div class="form-group">
                    <strong>Comentario</strong>
                    <input type="text" name="comentario" id="comentario"  class="form-control" style="height:25px;">
                </div>
