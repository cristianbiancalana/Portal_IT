...
<div class="container">
    <div class="row">
        ...
        <div class="alert alert-danger">
                ...
                </strong>Error al editar el sistema, verificar: <br><br>
                <ul>
        ...
        <div class="col-6 mt-4">
                <h3 class="text-white">Actualizar Sistema</h3>
                    <form action="{{route('sistemas.update',$sistema)}}" method="post">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <strong>Nombre del Sistema</strong>
                            <input type="text" name="name_sistema" id="name_sistema"  class="form-control" style="height:25px;" value="{{$sistema->name_sistema}}">
                        </div>
                        <div class="row justify-content-center">
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4 text-center mt-2">
                                <a href="{{route('vistasistemas')}}" class="btn btn-primary" style="width:100px;">Volver</a>
                            </div>
                        </div>
                    </form>
        </div>
