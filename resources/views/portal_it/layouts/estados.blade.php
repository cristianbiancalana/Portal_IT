...
<div class="container">
    <div class="row">
        ...
        <div class="alert alert-danger">
                ...
                </strong>Error al editar el estado<br><br>
                <ul>
        ...
        <div class="col-6 mt-4">
            <h3 class="text-white">Listado de Estados</h3>
            <div style="max-width: 1500px; margin: 0 auto; text-align:center;">
                <table class="table table-sm table-dark table-hover">
                    ...
                    <tbody>
                        ...
                        <td>{{$estado->name_estados}}</td>
                        <td style="width:150px; height: 20px; ">
                            <a href="{{route('estados.edit',$estado)}}" style="color:azure;">
                                <svg style="width: 22px; height: 20px;" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <div class="col-6 mt-4">
        <h3 class="text-white">Crear Estado</h3>
            <form action="{{route('store.estados')}}" method="post">
                @csrf
                <div class="form-group">
                    <strong>Nombre del Estado</strong>
                    <input type="text" name="name_estados" id="name_estados"  class="form-control" style="height:25px;">
                </div>
