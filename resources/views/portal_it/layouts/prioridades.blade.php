...
<div class="container">
    <div class="row">
        <div class="col-12">
            <div>
                <h2 class="text-white">Prioridades</h2>
            </div>
        </div>
        @if ($errors->any())
        ...
        <div class="col-6 mt-4">
            <h3 class="text-white">Listado de Prioridades</h3>
            <div style="max-width: 1500px; margin: 0 auto; text-align:center;">
                <table class="table table-sm table-dark table-hover" style="text-align:center;">
                    ...
                    <tbody>
                        ...
                        <td>{{$prioridad->name_prioridades}}</td>
                        <td style="width:150px; height: 20px; ">
                            <a href="{{route('prioridades.edit',$prioridad)}}" style="color:azure;">
                                <svg style="width: 22px; height: 20px;" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L6.832 19.82a4.5 4.5 0 0 1-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 0 1 1.13-1.897L16.863 4.487Zm0 0L19.5 7.125"></path>
                                </svg>
                            </a>
                            <form action="{{ route('prioridades.destroy', $prioridad) }}" method="post" style="display: inline;">
                                @csrf
                                @method('DELETE')
        ...
        <div class="col-6 mt-4">
        <h3 class="text-white">Crear Prioridad</h3>
            <form action="{{route('store.prioridades')}}" method="post">
                @csrf
                <div class="form-group">
                    <strong>Nombre de la Prioridad</strong>
                    <input type="text" name="name_prioridades" id="name_prioridades"  class="form-control" style="height:25px;">
                </div>
